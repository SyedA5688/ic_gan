...
if [ $dataset = 'imagenet' ]; then
  ...
  for i in "${!path_split[@]}"; do
    coco_data_path='/home/cougarnet.uh.edu/srizvi7/Desktop/ic_gan/datasets/coco/images/'${path_split[i]}'2017'
    coco_instances_path='/home/cougarnet.uh.edu/srizvi7/Desktop/ic_gan/datasets/coco/annotations/instances_'${path_split[i]}'2017.json'
    coco_stuff_path='/home/cougarnet.uh.edu/srizvi7/Desktop/ic_gan/datasets/coco/annotations/stuff_'${path_split[i]}'2017.json'
